...
const periods:Array<[Period,string]>=[['day','День'],['week','Неделя'],['month','Месяц'],['quarter','Квартал'],['year','Год'],['all','Все'],['custom','Произвольный период']];
...
export function PeriodPicker({value,onChange,showDay=true,showAll=true}:{value:PeriodValue;onChange:(value:PeriodValue)=>void;showDay?:boolean;showAll?:boolean}){
