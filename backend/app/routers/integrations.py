...
from app.services.clients_vr import ClientsVrError,get_buyer_types,get_manager_clients,get_managers
...
async def buyer_types():
 try:return await get_buyer_types()
 except ClientsVrError as exc:raise HTTPException(502,str(exc)) from exc
