...
async def list_sales(page:int=Query(1,ge=1),page_size:int=Query(50,ge=1,le=200),sort_by:str="sale_date",sort_dir:str="desc",search:str|None=None,date_from:date|None=None,date_to:date|None=None,departments:list[str]|None=Query(None),manager:str|None=None,buyer_type:str|None=None,client:str|None=None,author:str|None=None,price_type:str|None=None,promotion:str|None=None,social:bool|None=None,discount_card_percent:Decimal|None=None,min_amount:Decimal|None=None,max_amount:Decimal|None=None,min_discount:Decimal|None=None,max_discount:Decimal|None=None,db:AsyncSession=Depends(get_db)):
 ...
 if buyer_type:
  ...
  else:kw["clients"]=buyer_clients
 kw.pop("buyer_type",None)
...
async def delete_sales(payload:DeleteSales,db:AsyncSession=Depends(get_db)):
 if payload.all:
  ...
  if buyer_type:
   ...
   else:filters["clients"]=buyer_clients
