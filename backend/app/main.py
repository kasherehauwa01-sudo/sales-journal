...
from app.routers import analytics,ftp,horeca_reports,imports,integrations,meta,product_reports,sales,sales_dynamics_report,settings as settings_router
...
for router in (sales.router,imports.router,analytics.router,meta.router,ftp.router,integrations.router,product_reports.router,sales_dynamics_report.router,horeca_reports.router,settings_router.router):app.include_router(router,prefix="/api")
@app.get("/api/health")
