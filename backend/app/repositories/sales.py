...
def filtered_sales(q:Select, *,search=None,date_from:date|None=None,date_to:date|None=None,departments=None,client=None,author=None,price_type=None,promotion=None,social=None,discount_card_percent:Decimal|None=None,min_amount:Decimal|None=None,max_amount:Decimal|None=None,min_discount:Decimal|None=None,max_discount:Decimal|None=None):
 conditions=[]
 if search:
