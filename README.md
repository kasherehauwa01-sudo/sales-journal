...
- поиск листа и строки заголовков (первые 100 строк), сопоставление колонок по именам независимо от порядка;
...
- обзор KPI и сопоставимый прошлый период, динамика, магазины, товары, клиенты, скидки, акции и чеки;
